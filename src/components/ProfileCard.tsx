...
if (typeof document !== "undefined" && !document.getElementById(KEYFRAMES_ID)) {
  ...
  style.textContent = `
    @keyframes pc-holo-bg {
      0% { filter: brightness(0.4) contrast(1.1) saturate(0.15) opacity(0.15) hue-rotate(0deg); }
      100% { filter: brightness(0.4) contrast(1.1) saturate(0.15) opacity(0.15) hue-rotate(360deg); }
    }
  `;
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: getOffsets is stable
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      "--sunpillar-1": "hsl(220, 10%, 60%)",
      "--sunpillar-2": "hsl(220, 8%, 55%)",
      "--sunpillar-3": "hsl(220, 12%, 65%)",
      "--sunpillar-4": "hsl(220, 6%, 50%)",
      "--sunpillar-5": "hsl(220, 10%, 58%)",
      "--sunpillar-6": "hsl(220, 8%, 62%)",
  ...
  const shineStyle = {
    ...(iconUrl
      ...
      : {}),
    animation: "pc-holo-bg 8s linear infinite",
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        {/* biome-ignore lint/a11y/noStaticElementInteractions: tilt interaction handled via refs */}
        <section
        ...
        >
          ...
          >
            ...
            >
              <img
                className="w-3/4 absolute left-1/2 bottom-[10%] will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
